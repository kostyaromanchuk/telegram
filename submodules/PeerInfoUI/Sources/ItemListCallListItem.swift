...
public class ItemListCallListItem: ListViewItem, ItemListItem {
    ...
    public init(presentationData: ItemListPresentationData, dateTimeFormat: PresentationDateTimeFormat, messages: [Message], currentDate: TimeInterval, sectionId: ItemListSectionId, style: ItemListStyle, displayDecorations: Bool = true) {
...
public class ItemListCallListItemNode: ListViewItemNode {
    ...
    public func asyncLayout() -> (_ item: ItemListCallListItem, _ params: ListViewItemLayoutParams, _ insets: ItemListNeighbors) -> (ListViewItemNodeLayout, () -> Void) {
        ...
        return { [weak self] item, params, neighbors in
            ...
            let titleText = stringForDate(timestamp: Int32(item.currentDate), strings: item.presentationData.strings)
